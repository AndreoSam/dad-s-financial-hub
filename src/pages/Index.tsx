...
import { PiggyBank, Search, TestTube2, ArrowLeft } from "lucide-react";
      ...
      <header className="border-b border-border bg-card/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="container max-w-6xl mx-auto px-3 sm:px-4 py-2.5 sm:py-4 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <NotificationButton />
            {testingMode ? (
              <ButtonLink to="/" icon={ArrowLeft} label="Main" />
            ) : (
              <ButtonLink to="/testing" icon={TestTube2} label="Testing Copy" />
            )}
